					...
					<article className="textContainer">
						...
						<div className="textImageContainer">
							<p>
								...
								affection oculaire chronique qui affecte la macula, la partie
								centrale de la rétine, responsable de la vision fine et des
								détails. Elle entraîne une perte progressive de la vision
								centrale, rendant des tâches comme la lecture, l’écriture, ou la
								reconnaissance des visages de plus en plus difficiles. La vision
								périphérique reste généralement intacte, ce qui empêche une
								cécité totale, mais l’impact sur la qualité de vie peut être
								important. La DMLA est une des principales causes de malvoyance
								chez les personnes âgées, et son évolution varie en fonction de
								la forme de la maladie : sèche ou humide.
							</p>
