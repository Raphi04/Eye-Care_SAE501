					...
					<article className="textContainer">
						...
						<div className="textImageContainer">
							<p>
								...
								est causé par une perte progressive de souplesse du cristallin,
								la lentille naturelle de l'œil, qui permet normalement de faire
								la mise au point sur différentes distances. Avec le temps, le
								cristallin devient moins flexible et les muscles oculaires
								peinent à ajuster sa courbure, rendant la vision de près floue.
								Ce trouble commence généralement à se manifester après l’âge de
								40 ans et tend à s’accentuer jusqu’à environ 60 ans. Bien que la
								presbytie soit une conséquence naturelle du vieillissement et
								non une maladie en soi, elle peut considérablement impacter les
								activités quotidiennes comme la lecture ou l’utilisation d’un
								écran.
							</p>
