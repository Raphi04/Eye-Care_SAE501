				...
				<section className="presentationMaladie">
					<article className="textContainer">
						...
						<div className="textImageContainer">
							<p>
								L’hypermétropie est un trouble de la vision qui se traduit par
								une difficulté à voir nettement les objets proches, tandis que
								la vision des objets éloignés reste généralement claire. Cela
								est dû à un problème de focalisation : les rayons lumineux
								entrant dans l'œil convergent derrière la rétine au lieu de
								converger directement sur celle-ci. Cette anomalie peut résulter
								d’un œil trop court ou d’une courbure insuffisante de la cornée
								ou du cristallin. Les personnes atteintes d’hypermétropie
								peuvent ressentir des symptômes tels que des maux de tête, une
								fatigue oculaire, ou une gêne après une lecture prolongée ou
								l’utilisation d’écrans. Ce trouble peut survenir à tout âge,
								mais il est souvent détecté chez les enfants ou devient plus
								prononcé avec l’âge, lorsque la capacité naturelle de l’œil à
								compenser le défaut diminue.
							</p>
							<img
