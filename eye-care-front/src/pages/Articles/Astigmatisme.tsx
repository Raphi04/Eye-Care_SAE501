					...
					<article className="textContainer">
						...
						<div className="textImageContainer">
							<p>
								...
								altérée des formes et des contours, rendant les lignes droites
								ou les détails difficiles à discerner. Par exemple, les lettres
								sur une page ou les panneaux de signalisation peuvent sembler
								dédoublés ou brouillés. Bien que ce trouble ne soit pas une
								maladie grave, il peut causer de la fatigue oculaire, des maux
								de tête et une gêne dans la vie quotidienne, surtout lorsqu’il
								n’est pas corrigé.
							</p>
							<img
