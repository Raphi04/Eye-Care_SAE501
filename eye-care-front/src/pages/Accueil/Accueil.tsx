      ...
      <main className="accueil">
        ...
        <section className="fonctionnementOeil">
          <article className="textContainer">
            ...
            <Link to="/articles/oeil" className="button button-white">
        ...
        <section className="blogDiscussion">
          ...
          <article className="discussion1">
            <div>
              <p>
                Bonjour, j’ai remarqué que depuis quelques jours, lorsque je me réveille, je suis
                totalement aveugle pendant quelques minutes. Cela dure plusieurs minutes avant que
                ma vision commence à revenir. Je dors souvent sur le ventre, est-ce que cela
          ...
          <article className="discussion2">
            <div>
              <p>
                Bonjour ! Ce type de problème peut parfois être lié à une pression exercée sur vos
                yeux pendant que vous dormez. Dormir sur le ventre peut comprimer vos globes
                oculaires, ce qui pourrait expliquer cette perte de vision temporaire au réveil. Je
                vous recommande d’essayer de changer de position pour dormir et de surveiller si
                cela s’améliore. Toutefois, ce problème mérite d’être examiné de plus près par un
                professionnel si les symptômes persistent. Vous avez des doutes ou souhaitez
                d’autres conseils ?{" "}
                <b>
                  Rejoignez notre forum pour poser toutes vos questions. D’autres utilisateurs ou
                  professionnels pourront également partager leurs expériences et vous guider !
                </b>
              </p>
              <div className="username">
                <p>Dr. Eggman</p>
