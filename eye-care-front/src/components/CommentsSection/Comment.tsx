		...
		if (newLikedState) {
			...
			try {
				...
				const response = await fetch(
					`${APIURL}/user/vote/${commentData.id}`,
					requestOptions
				);
			...
			<div className="commentAndReplyContainer">
				<div className="comment">
					<div className="userIcon">
						{commentData.user_profile ? (
							<img
								src={`${APIURL}/uploads/images/profile/${commentData.user_profile}`}
								alt="Photo de profil"
							...
							<div className="mainActions">
								...
								>
									<FontAwesomeIcon
										...
										className={
											commentData.is_disliked || isDisliked ? "red" : ""
										}
									/>
