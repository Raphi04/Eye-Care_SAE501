		...
		<>
			<div className="testNavigation">
				<div className="linkContainer">
					<Link
						to="acuite"
						className={`link ${currentArticle == "acuite" ? "active" : ""}`}
					>
						<p>Test d'acuité visuelle</p>
					</Link>
				</div>
				...
				<div className="linkContainer">
					<Link
						to="dmla"
						className={`link ${currentArticle == "dmla" ? "active" : ""}`}
					>
						<p>Test de DMLA</p>
					</Link>
				</div>
				...
				<div className="linkContainer">
					<Link
						to="ishihara"
						className={`link ${currentArticle == "ishihara" ? "active" : ""}`}
					>
						<p>Test d'Ishihara</p>
					</Link>
				</div>
