        ...
        <ScrollView style={styles.safeContainer}>
                ...
                <View style={styles.accueil}>
                    ...
                    <Text style={styles.texte}>
                        ...
                        <Text style={styles.texte}>
                            • Pour <Text style={{ fontWeight: "bold" }}>la forme sèche</Text>, il n’existe pas de traitement curatif, mais des mesures préventives comme une alimentation riche en antioxydants (vitamines C et E, zinc, lutéine) et des compléments alimentaires peuvent ralentir la progression de la maladie.
                        </Text>

                        <Text style={styles.texte}>
                            • Pour la <Text style={{ fontWeight: "bold" }}>forme humide</Text>, des traitements par injections intraoculaires (anti-VEGF) permettent de stopper la croissance des néovaisseaux responsables des dégâts à la rétine et d’améliorer la vision dans certains cas.
                        </Text>

                        <Text style={styles.texte}>
                            La <Text style={{ fontWeight: "bold" }}>rééducation visuelle</Text> et l’utilisation d’aides optiques (loupe électronique, lunettes spécifiques) permettent d’aider les patients à mieux vivre avec la maladie. Un suivi régulier chez l’ophtalmologue est essentiel pour détecter la maladie tôt, surtout si des symptômes comme des lignes droites apparaissent déformées ou si une tâche floue se développe dans le champ de vision central. Plus le diagnostic est précoce, meilleures sont les chances de ralentir l’évolution de la DMLA.
                        </Text>
                    </View>
